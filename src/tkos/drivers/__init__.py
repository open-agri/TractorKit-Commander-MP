...
_R_CCW_1 =   const(0x3)
_R_CCW_2 =   const(0x4)
_R_ILLEGAL = const(0x5)

_transition_table = [

  #|------------- NEXT STATE -------------|            |CURRENT STATE|
  # CLK/DT    CLK/DT       SAME       CLK/DT               
  #   00        01          10         11
  [_R_START, _R_CCW_1,  _R_START,   _R_CW_1,],            # _R_START
  [_R_START, _R_CW_2,   _R_CW_1,    _R_CW_1,],            # _R_CW_1
  [_R_START | _DIR_CW,  _R_CW_2,    _R_CW_2,   _R_CW_1,], # _R_CW_2
  [_R_START, _R_CCW_1,  _R_CCW_1,   _R_CCW_2],            # _R_CCW_1  
  [_R_START | _DIR_CCW, _R_CCW_1,   _R_CCW_2,  _R_CCW_2], # _R_CCW_2  
...
class Rotary(object): 
    ...
    def __init__(self, min_val, max_val, reverse, range_mode, pin_clk, pin_dt):
    ...
    def _process_rotary_pins(self, pin):
        ...
        if(pin is self._pin_clk):
            clk_dt_pins = (pin.irqvalue() << 1) | self._hal_get_dt_value()
        elif (pin is self._pin_dt):
            clk_dt_pins = (self._hal_get_clk_value() << 1) | pin.irqvalue()

        # print(bin(clk_dt_pins)[2:])
